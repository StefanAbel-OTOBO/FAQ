...
$Selenium->RunTest(
    sub {
        ...
        # OTOBOBusiness package is required for this test. Skip if it is not available.
        ...
        if ( !$BusinessInstalled ) {
            $Self->True(
                1,
                "OTOBOBusiness is not installed, skip this test."
            );
            return 1;
        }
        ...
        # Test case for bug#12900 ( https://bugs.otobo.org/show_bug.cgi?id=12900 ).
